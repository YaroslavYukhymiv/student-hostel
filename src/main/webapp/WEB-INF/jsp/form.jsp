            ...
            <form:form method="post" action="/save">
                <form class="form-signin">
                    ...
                    <form:input type="text" id="inputEmail" class="form-control text-white bg-dark"
                                placeholder="FirstName" required="" autofocus="" path="firstName"/>
                    <form:input type="text" id="inputPassword" class="form-control mt-3 text-white bg-dark"
                                placeholder="Second name" required="" path="secondName"/>
                    <form:input type="text" id="inputPassword" class="form-control mt-3 text-white bg-dark"
                                placeholder="RoomNumber" required="" path="roomNumber"/>
                    <form:input type="text" id="inputPassword" class="form-control mt-3 text-white bg-dark"
                                placeholder="Faculty" required="" path="faculty"/>
                    <form:input type="text" id="inputPassword" class="form-control mt-3 text-white bg-dark"
                                placeholder="Birthday" required="" path="birthday"/>
